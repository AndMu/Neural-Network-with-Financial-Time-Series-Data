...
class TechnicalPerformance:
    @staticmethod
    def compute_std(data, window=20):
    ...
    @staticmethod
    def compute_macd(data, n_fast=12, n_slow=26, signal_period=9):
        '''
    ...
    @staticmethod
    def compute_bollinger_bands(data, window=20, deviation=2):
